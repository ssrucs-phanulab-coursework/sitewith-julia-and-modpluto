...
MethodInstance for Main.workspace#4.double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.workspace#4 at /home/runner/work/sitewith-julia-and-modpluto/sitewith-julia-and-modpluto/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 990 evaluations.
 Range (min … max):   43.030 ns … 28.374 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      45.355 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   128.892 ns ±  1.075 μs  ┊ GC (mean ± σ):  1.79% ± 1.39%

  ▄▅██▆▄▄▄▄▃▁    ▁▂▁                                           ▂
  ███████████▇▇▇▇█████▇▇▆▆▅▆▆▄▄▄▄▃▄▁▄▁▃▁▄▁▁▁▃▁▁▃▁▁▁▁▁▁▁▁▁▁▁▃▁▃ █
  43 ns         Histogram: log(frequency) by time      85.8 ns <
...
BenchmarkTools.Trial: 10000 samples with 996 evaluations.
 Range (min … max):  24.900 ns …  12.618 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     26.807 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   59.415 ns ± 519.694 ns  ┊ GC (mean ± σ):  3.65% ± 1.71%

  ▅▄▂▂  ▆█▇▆▃        ▁▁ ▁        ▁      ▂▃▃▄▃▃▄▂▂▃▁            ▂
  ████▇███████▇▅▄▅▅▆█████▇▇█▆▅▇▇█████▆▆██████████████▆▇▇▆▆▆▅▆▅ █
  24.9 ns       Histogram: log(frequency) by time      38.9 ns <
